...
if st.button("Extract Job Details") and job_url:
    if not os.getenv("PERPLEXITY_API_KEY"):
        ...
        with st.spinner("Processing... This might take a moment..."):
            try:
                llm = PerplexityLLM(api_key=os.getenv("PERPLEXITY_API_KEY"))
                ...
                with ThreadPoolExecutor(max_workers=2) as executor:
                    ...
                    try:
                        job_text, job_info = future_job_extraction.result(timeout=60) # Add a timeout for extraction
                        ...
                        if job_info: # Only proceed with fit evaluation if job_info was successfully extracted
                            ...
                            if resume:
                                ...
                                fit_report = None
                                try:
                                    fit_report = future_fit_evaluation.result(timeout=60) # Add a timeout for evaluation
